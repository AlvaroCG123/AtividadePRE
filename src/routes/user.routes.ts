...
router.patch("/atualizar",authMiddleware,requireAdminMiddleware, updateOneUsuario)
router.delete("/delete",authMiddleware,requireAdminMiddleware, DeleteOneUsuario)
